...
class NumerosOrd extends HTMLElement {
    ...
    connectedCallback(){
        ...
        this.items.forEach(item => {
            ...
            this.shadowRoot.querySelector('.items2').append( createNumbersOrd(this.str2) );
            this.shadowRoot.querySelector('.items3').append( createNumbersOrd(this.str3) );
            this.shadowRoot.querySelector('.items4').append( createNumbersOrd(this.str4) );
        })
