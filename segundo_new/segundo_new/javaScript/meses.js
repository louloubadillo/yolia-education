...
class Meses extends HTMLElement {
    ...
    connectedCallback(){
        ...
        this.items.forEach(item => {
            ...
            this.shadowRoot.querySelector('.items2').append( createMes(this.str2) );
            this.shadowRoot.querySelector('.items3').append( createMes(this.str3) );
            this.shadowRoot.querySelector('.items4').append( createMes(this.str4) );
        })
